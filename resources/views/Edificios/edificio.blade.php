                    ...
                    <form id="form" name="form" class="needs-validation" autocomplete="off" novalidate>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('nombre') is-invalid @enderror" name="nombre"
                                id="nombre" placeholder="Nombre del ambiente" required>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('codigo') is-invalid @enderror" name="codigo"
                                id="codigo" placeholder="Código del ambiente" required>
                            <div class="invalid-feedback"></div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01"
                                class="form-control @error('metro_cuadrado') is-invalid @enderror" name="metro_cuadrado"
                                id="metro_cuadrado" placeholder="Metros cuadrados del ambiente" required>
                            <div class="invalid-feedback"></div>
                        </div>
        ...
        <div id="form-container-piso" class="hidden ">
            <div class="form-content">
                <div class="form-header">
                    ...
                    <button type="button" class="btn-close" id="close-form2"></button>
                </div>
                <div class="form-body-piso">
                    <form id="form2" name="form2" class="needs-validation" autocomplete="off" novalidate>
                        ...
                        <div class="">
                            <select class="form-select mb-4" name="id_piso" id="id_piso">
                                ...
                                <option value="{{ $pisos_ambientes[0]->id_piso }}">{{ $pisos_ambientes[0]->numero }}.-
