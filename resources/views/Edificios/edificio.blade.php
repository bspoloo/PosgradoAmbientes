                ...
                <div class="container">
                    ...
                    <div class="actions">
                        ...
                        <button id="editLocation" class="editLocation">
                            <img id="editLocationIcon" src="/images/lapiz-abierto.png" alt="Editar ubicacion"
                                width="25px">
                        </button>
                        <button id="editPoligono" class="editLocation">
                            <img id="editPoligonoIcon" src="/images/poligono-abierto.png" alt="Editar ubicacion"
                                width="25px">
                        </button>
            ...
            <div id="form-container-piso" class="hidden ">
                <div class="form-content">
                    <div class="form-header">
                        ...
                        <button type="button" class="btn-close" id="close-form-piso"></button>
                    </div>
                    <div class="form-body-piso">
                        <form id="form-piso" name="form-piso" class="needs-validation" autocomplete="off" novalidate>
